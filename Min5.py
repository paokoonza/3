...
#==============================================================================================================
                       ...
                       for target in targets:
                        ...
                        if msg._from in Family:
                            try:
                                ...
                                ka.sendMessage(msg.to,"ลบทุกการแชทเรียบร้อย")
                                kb.sendMessage(msg.to,"ลบทุกการแชทเรียบร้อย")
                                kc.sendMessage(msg.to,"ลบทุกการแชทเรียบร้อย")
                                kd.sendMessage(msg.to,"ลบทุกการแชทเรียบร้อย")
                            except:
                                pass
                                print ("ลบแชทคิก")
                ...
                elif text.lower() == ".หำจำ":                     
                	ki.sendMessage(to, "Ping")      
                    kk.sendMessage(to, "Ping")           
                    kc.sendMessage(to, "Ping")      
                    ke.sendMessage(to, "Ping")         
                    km.sendMessage(to, "Ping")      
                    ka.sendMessage(to, "Ping")           
                    kb.sendMessage(to, "Ping")      
                    kc.sendMessage(to, "Ping")             
                    kd.sendMessage(to, "Ping")             
