...
settings = {
    ...
    "messageadd":"สวัสดีครับสนใจบอทราคากันเอง  เด้งแชทรั่วเลยนะครับ",
    "message":"บัญชีนี้ถูกป้องกันโดย Selfbot [BY.มินทีมทดลองบอท]ระบบได้ทำการบล็อคคุณอัตโนมัติเนื่องจากคุณยังไม่ได้ยืนยันตัวตนกับผู้สร้างบอท\nสามารถยืนตัวตนได้ง่ายโดยการพิม unblockกับ[BY.มินทีมทดลองบอท]ระบบจะทำการปลดบล็อคท่านโดยอัตโนมัต",
    "comment":"""selfbot by:
╔══════════════┓
╠™[BY.มินทีมทดลองบอท]
╚══════════════┛""",
